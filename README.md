# EEGdecoding_SQM
We present in this repository the code and data necessary to reproduce the results shown in Menétrey, Herzog & Pascucci (under review). Neural evidence for long-lasting unconscious visual processing. 
